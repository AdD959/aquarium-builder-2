    ...
    <div class="bg-[#2f2e2e] p-6 px-8 flex flex-col gap-1 relative justify-between aspect-square group overflow-auto">
      ...
      <div class="gap-2 flex w-full justify-end text-white">
        ...
        <button @click="selectSize('medium')" class="bg-[#1c1c1c] px-2 py-1 border"
          :class="size.includes('medium') ? 'border-white' : 'border-[#1c1c1c]'">M</button>
        <button @click="selectSize('large')" class="bg-[#1c1c1c] px-2 py-1 border"
          :class="size.includes('large') ? 'border-white' : 'border-[#1c1c1c]'">L</button>
      </div>
      <div class="flex items-center justify-center relative">
        <svg class="h-full rotate-[20deg]" width="167" height="72" viewBox="0 0 167 72" fill="none"
